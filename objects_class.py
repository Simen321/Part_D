...
regions_encoded = encoder.fit_transform(data[['region']]).toarray()
...
train_class_percentage = 100 * train_class_counts / len(y_train)
test_class_percentage = 100 * test_class_counts / len(y_test)

print("Training set class distribution (count):")
print(train_class_counts)
print("\nTraining set class distribution (%):")
print(train_class_percentage)

print("\nTesting set class distribution (count):")
...
print("\nRandom Forest Classifier Accuracy:", accuracy_score(y_test, predictions_rf))
...
print("\nDecision Tree Classifier Accuracy:", accuracy_score(y_test, predictions_dt))
